package hus.oop.lab4.exercise2.authorandbookyourturn;
...
// Test Book class
        ...
        System.out.println("author is: " + book1.getAuthor()); // Author’stoString ()
        System.out.println("author’s name: " + book1.getAuthorName());
        System.out.println("author’sname: " + book1.getAuthor().getName());
